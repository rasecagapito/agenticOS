...
2. Ler arquivo do worker na íntegra.

3. Carregar contexto da seção "Contexto a Carregar".
...
4. Confirmar:
   > "Worker [nome] ativo. Contexto: [lista]. Skills disponíveis: [lista]. Pronto para [função]."

5. Seguir sequência de ativação definida no worker — incluindo skills obrigatórias antes de implementar.
